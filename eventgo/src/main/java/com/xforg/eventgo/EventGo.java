...
public class EventGo {
    public static final String TAG = "EventGo";

    static volatile EventGo defaultInstance;
    private static final EventGoBuilder DEFAULT_BUILDER = new EventGoBuilder();
    ...
    public static EventGo getDefault() {
        EventGo instance = defaultInstance;
        if (instance == null) {
            synchronized (EventGo.class) {
                instance = EventGo.defaultInstance;
                if (instance == null) {
                    instance = EventGo.defaultInstance = new EventGo();
                }
            }
        }
        return instance;
    ...
    public static EventGoBuilder builder() {
        return new EventGoBuilder();
    }
    ...
    EventGo(EventGoBuilder builder) {
    ...
    public String toString() {
        return "EventBus["  + "eventInheritance=" + eventInheritance + "]";
    }
